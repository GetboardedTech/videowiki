...
export declare class DataTokens {
    ...
    proposeMinter(dataTokenAddress: string, newMinterAddress: string, address: string): Promise<string>;
    approveMinter(dataTokenAddress: string, address: string): Promise<string>;
