    ...
    OceanUtils.getInstance = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                instance = new OceanUtils();
                instance.setInstanceConfig(config);
                instance.signature = new SignatureUtils_1.SignatureUtils(config.web3, config.logger);
                instance.fetch = new WebServiceConnector_1.WebServiceConnector(config.logger);
                return [2, instance];
            });
        });
    };
