...
var Account = (function (_super) {
    ...
    Account.prototype.getTokenBalance = function (TokenAdress) {
        return __awaiter(this, void 0, void 0, function () {
            var minABI, result, token, _a, _b, e_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        e_1 = _c.sent();
                        this.logger.error("ERROR: Failed to get the balance: " + e_1.message);
                        return [3, 4];
    ...
    Account.prototype.getEtherBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.web3.eth.getBalance(this.id, 'latest')];
                    case 1:
                        result = _a.sent();
